...
@gf.cell
def graphene(width: float = 3.0, length: float = 5.0, layer=(3, 0)) -> gf.Component:
    c = gf.Component()
    ...
    c.add_label(text="Graphene", position=(x_left, y_under))
...
graphene_1 = c << graphene(40e-3, 20e-3)
negative_electrode = c << cold_electrode(30e-3, 30e-3)
positive_electrode = c << warm_electrode(30e-3, 30e-3)

negative_electrode.connect("junction_graphene", graphene_1.ports["junction_neg"], allow_layer_mismatch=True,
